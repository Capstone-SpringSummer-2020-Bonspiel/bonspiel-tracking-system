...
@Component({
  selector: 'app-create-curling-game',
  templateUrl: './create-curling-game.component.html',
  styleUrls: ['./create-curling-game.component.scss']
})
export class CreateCurlingGameComponent implements OnInit {
