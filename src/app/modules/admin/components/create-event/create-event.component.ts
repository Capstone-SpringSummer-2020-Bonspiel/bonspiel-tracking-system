...
export class CreateEventComponent implements OnInit {
  ...
  onClickSubmit(stepper: MatStepper) {
    ...
    var adjusttime = new Date(this.thirdFormGroup.controls.eventEndCtrl.value.getTime() + (23 * 60 * 60 * 1000 + 59 * 60 * 1000 + 59 * 1000));
    const end_date = String(adjusttime.toLocaleString());
