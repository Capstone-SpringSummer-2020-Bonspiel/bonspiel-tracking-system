...
export class ApiService {
  ...
  public editCurler(name, position, affiliation, curlingTeamId, curlerId) {
    ...
    return this.httpService.put(`${environment.apiUrl}/api/v1/admin/curler/${curlerId}`, body);
  }
  ...
  public createEndScore(gameId, endNumber, blank, curlingTeam1Scored, score) {
    ...
    return this.httpService.post(`${environment.apiUrl}/api/v1/admin/${gameId}/end`, body);
  }
  ...
  public editEndScore(endId, blank, curlingTeam1Scored, score) {
    ...
    return this.httpService.put(`${environment.apiUrl}/api/v1/admin/end/${endId}`, body);
  }
  ...
  public createTeam(name, note, orgId) {
    ...
    return this.httpService.post(`${environment.apiUrl}/api/v1/admin/team`, body);
  }
